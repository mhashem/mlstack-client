...
import co.rxstack.mlstack.client.config.Constants;
import co.rxstack.mlstack.client.ClientApp;
import co.rxstack.mlstack.client.domain.Authority;
import co.rxstack.mlstack.client.domain.User;
import co.rxstack.mlstack.client.repository.AuthorityRepository;
import co.rxstack.mlstack.client.repository.UserRepository;
import co.rxstack.mlstack.client.security.AuthoritiesConstants;
import co.rxstack.mlstack.client.service.MailService;
import co.rxstack.mlstack.client.service.dto.UserDTO;
import co.rxstack.mlstack.client.service.dto.PasswordChangeDTO;
import co.rxstack.mlstack.client.web.rest.errors.ExceptionTranslator;
import co.rxstack.mlstack.client.web.rest.vm.KeyAndPasswordVM;
import co.rxstack.mlstack.client.web.rest.vm.ManagedUserVM;
import co.rxstack.mlstack.client.service.UserService;
